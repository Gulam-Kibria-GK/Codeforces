...
int main()
{
   ...
   if(f==1){
    if(st==st2){cout<<"YES"<<endl;return 0;}
   }
   if(f==1 || n-1>m){cout<<"NO"<<endl;return 0;}
   for(i=0;i<stx.size();i++){
    if(st2[i]!=stx[i]){cout<<"NO"<<endl;return 0;}
   }
   reverse(st2.begin(),st2.end());
   reverse(sty.begin(),sty.end());
   for(i=0;i<sty.size();i++){
        if(st2[i]!=sty[i]){cout<<"NO"<<endl;return 0;}
   }
   cout<<"YES"<<endl;
   return 0;
}