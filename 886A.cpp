...
int main()
{
    ...
    arr[0]=v1[0]+v1[1]+v1[2];
    arr[1]=v1[3]+v1[4]+v1[5];
    arr[2]=v1[0]+v1[1]+v1[3];
    arr[3]=v1[2]+v1[4]+v1[5];
    arr[4]=v1[0]+v1[1]+v1[4];
    arr[5]=v1[2]+v1[3]+v1[5];
    arr[6]=v1[0]+v1[1]+v1[5];
    arr[7]=v1[2]+v1[3]+v1[4];
    arr[8]=v1[0]+v1[2]+v1[3];
    arr[9]=v1[1]+v1[5]+v1[4];
    arr[10]=v1[0]+v1[2]+v1[4];
    arr[11]=v1[1]+v1[3]+v1[5];
    arr[12]=v1[0]+v1[2]+v1[5];
    arr[13]=v1[1]+v1[3]+v1[4];
    arr[14]=v1[0]+v1[3]+v1[4];
    arr[15]=v1[1]+v1[2]+v1[5];
    arr[16]=v1[0]+v1[3]+v1[5];
    arr[17]=v1[1]+v1[2]+v1[4];
    arr[18]=v1[0]+v1[4]+v1[5];
    arr[19]=v1[1]+v1[2]+v1[3];
    for(i=0;i<20;i++)
    {
