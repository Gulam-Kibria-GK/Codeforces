...
int main()
{
    ...
    cout<<6-n<<endl;
    if(m["purple"]==0)cout<<"Power"<<endl;
    if(m["green"]==0)cout<<"Time"<<endl;
    if(m["blue"]==0)cout<<"Space"<<endl;
    if(m["orange"]==0)cout<<"Soul"<<endl;
    if(m["red"]==0)cout<<"Reality"<<endl;
    if(m["yellow"]==0)cout<<"Mind"<<endl;
    return 0;
}