...
char wow(char s)
{
    if(s=='A' || s=='b' || s=='d' || s=='H' || s=='I' || s=='M' || s=='O' || s=='o'||s=='p' || s=='q'|| s=='Y'||s=='T'||s=='U'||s=='V'||s=='v'||s=='W'||s=='w'||s=='X'||s=='x')
    {
        return '1';
    }
    else return '0';
...
char wow2(char s)
{
    if(s=='A' || s=='H' || s=='I' || s=='M' || s=='O' || s=='o'|| s=='Y'||s=='T'||s=='U'||s=='V'||s=='v'||s=='W'||s=='w'||s=='X'||s=='x')
    {
        return '1';
    }
    else return '0';
...
int main()
{
    int i,j,k,l=0,n,m,a=0,b=0,x=0,f=0;
    string st,st2="",st3="";
    cin>>st;
    n=st.size();
